classdef digiClock < handle
    ...
    methods
        ...
        function obj = digiClock(varargin)
            ...
            obj.numbers    = sevSegDisp(1,  1);%hours
            obj.numbers(2) = sevSegDisp(24, 1);%hours
            obj.colons     = clockColon(48, 1);
            obj.numbers(3) = sevSegDisp(57, 1);%minutes
            obj.numbers(4) = sevSegDisp(81, 1);%minutes
            obj.colons(2)  = clockColon(105,1);
            obj.numbers(5) = sevSegDisp(114,1);%seconds
            obj.numbers(6) = sevSegDisp(138,1);%seconds
...
%              addlistener(obj,'flagChange', 'PostSet', @obj.postSetNumberFcn);
            addlistener(obj,'parentClosed', @parentClosedFcn);
            imshow(obj, 'Border', 'loose');
        end
